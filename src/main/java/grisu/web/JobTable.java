...
public class JobTable extends CustomComponent {
	...
	/**			//These details are now displayed in UserTable
	@AutoGenerated
	private Label lblDn;
	@AutoGenerated
...
//	in the Multimap value list	
	...
	public JobTable() {
		...
		//tblJobsInactive.setPageLength(15);
...
*/
	...
	public void populate(final String dn, final UserTable userTab) {
		// TODO Auto-generated method stub
...
//						lblClient.setValue("Client(s): "+client.substring(0, client.length()-2));
						userDetails[2]=client.substring(0, client.length()-2);
					}
...
//						lblApps.setVisible(true);
						userDetails[3]= appList.substring(0, appList.length()-2);
					}
...
//					lblTotJobs.setValue("Total Jobs: "+jobCount +"(Active: "+tblJobs.size()+", Running: "+jsDao.findRunningJobCount(dn)+")");
					userDetails[0]=jobCount +"(Active: "+tblJobs.size()+", Running: "+jsDao.findRunningJobCount(dn)+")";
...
//					lblWalltime.setValue("Average Walltime per CPU: "+WalltimeUtils.convertSeconds((int) (wallTimeAvg*60)));
				...
				tblJobs.setSortContainerPropertyId("submitted");
				tblJobs.setSortAscending(true);
				tblJobs.sort();
				
				tblJobsInactive.setSortContainerPropertyId("submitted");
				tblJobsInactive.setSortAscending(true);
				tblJobsInactive.sort();
			}
		};
